...
from notebooks.agile_v2 import AgileFeatures, PROFILES, expert, reset_course, DroneEnv
...
def run(output, episodes=12, epochs=100, rounds=3, ppo_steps=8192, max_level=7, final_cases=16):
    ...
    for name in ("train_agile_v2.py", "agile_v2.py", "agile_curriculum.py"):
